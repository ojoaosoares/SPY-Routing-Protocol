...
bool
SpyExample::Configure (int argc, char **argv)
{
  // Enable SPY logs by default. Comment this if too noisy
  // LogComponentEnable("SpyRoutingProtocol", LOG_LEVEL_ALL);
...
void
SpyExample::Report (std::ostream &)
{
}

void
SpyExample::CreateNodes ()
{
...
SpyExample::CreateDevices ()
{
  ...
  if (pcap)
    {
      wifiPhy.EnablePcapAll (std::string ("spy"));
    }
}

void
SpyExample::InstallInternetStack ()
{
  SpyHelper spy;
  // you can configure SPY attributes here using spy.Set(name, value)
  InternetStackHelper stack;
  stack.SetRoutingHelper (spy);
  stack.Install (nodes);
...
void
SpyExample::InstallApplications ()
{
